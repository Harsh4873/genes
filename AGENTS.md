...
This repository hosts MtbScope, a browser for the *M. tuberculosis* H37Rv genome, published under `/genes/`.
...
- The `main` branch deploys directly to the repository's GitHub Pages project site.
